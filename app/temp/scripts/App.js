...
var _pageSections = __webpack_require__(6);
...
var MobileMenu = function () {
	...
	_createClass(MobileMenu, [{
		...
		value: function createMenuWaypoint() {
			var that = this;
			new Waypoint({
...
var StickyHeader = function () {
	...
	_createClass(StickyHeader, [{
		...
		key: 'onDocLoad',
		value: function onDocLoad() {
			var that = this;
			(0, _jquery2.default)(document).ready(function () {
				that.btn4.addClass('btn-4-load');
			});
			this.btn4.hover(function () {
				that.btn4.removeClass('btn-4-load');
			});
		}
	}, {
...
var pageSections = function () {
	...
	_createClass(pageSections, [{
		key: 'createAnimationWaypoints',
		value: function createAnimationWaypoints() {
			var that = this;
			this.waypoints.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						...
						(0, _jquery2.default)(currentWaypoint).addClass(waypointAnimation);
					},
					offset: '50%'
				});
			});
